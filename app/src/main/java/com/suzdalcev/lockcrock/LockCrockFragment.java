...
import android.content.Intent;
    ...
    import static com.suzdalcev.lockcrock.R.id.fragment_nerd_launcher_recycler_view;


public class LockCrockFragment extends Fragment {

    private static final String TAG = "NerdLauncherFragment";
    private RecyclerView mRecyclerView;

    public static LockCrockFragment newInstance() {
        return new LockCrockFragment();
    }
